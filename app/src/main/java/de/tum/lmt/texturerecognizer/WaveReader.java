 ...
 * taken from https://github.com/raphlinus/music-synthesizer-for-android/blob/master/core/src/com/levien/synthesizer/core/wave/WaveReader.java
 */
public class WaveReader {
	private String TAG = "WaveReader";
	/**
	...
	public WaveReader(InputStream in) throws IOException {
		...
		@SuppressWarnings("unused")
		int byteRate = (int)input.readDWord()/2;
		@SuppressWarnings("unused")
		...
		Log.i(TAG , "WaveReader running NumChannels: " + numChannels_ + ", bitsPerSample: " + bitsPerSample + ", bytesPerSample: " + 
				bytesPerSample + ", sampleRateInHz: " + sampleRateInHz_ + ", byteRate: " + byteRate);
